...
const EditUserInform = ({ route, navigation }) => {
    ...
    async function handleChange() {
        try {
            const resp = await axios.post("http://192.168.200.116:8080/user/changeInfo", {
                userAddress,
                phone,
                account,
                name,
    ...
    async function sendVerificationCode() {
        try {
            const resp = await axios.post("http://192.168.200.116:8080/user/sendVerificationCode", { phone });
            if (resp.data) {
