...
const PostListScreen = ({ navigation, route }) => {
  ...
  async function getPostList() {
    try {
      const resp = await axios.get('http://192.168.200.142:8080/posts/region')
    ...
    >
      <View style={styles.postItem}>
        ...
        <View style={styles.postContent}>
          ...
          {post.additionalInfo && (
            <Text style={styles.additionalInfo}>{post.additionalInfo}</Text>
          )}
        </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomBar}>
        ...
        <TouchableOpacity
          onPress={() => navigation.navigate('ChatButton', { userId: userId })}
          style={styles.bottomBarItem}
        >
          <MaterialIcons name="chat" size={24} color="black" />
        </TouchableOpacity>
        <TouchableOpacity
          onPress={() => navigation.navigate('MyPage', { userId: userId })}
          style={styles.bottomBarItem}
        >
