...
// //         try {
// //             const resp = await axios.get("http://172.30.1.81:8080/posts/region")
...
//     setLoading(true);
//     try {
//       const resp = await axios.get('http://172.30.1.81:8080/posts/region', { timeout: 8000 });
//       if (resp?.data) {
//         setTownName(resp.data.townName);
//         setPosts(resp.data.posts ?? []);
//       }
...
const SERVER_URL = 'http://172.30.1.81:8080'; // ✅ 한 곳에서 관리
