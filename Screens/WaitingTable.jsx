...
const WaitingTableScreen = ({ navigation, route }) => {
    ...
    const fetchPendingUser = async () => {
        try {
            const response = await axios.get(
                `http://192.168.219.45:8080/waitingdeal/userpending/${postId}` /* + postId*/
            )
    ...
    const fetchAcceptedUser = async () => {
        try {
            const response = await axios.get(
                `http://192.168.219.45:8080/waitingdeal/useraccepted/${postId}` /* + postId*/
            )
    ...
    const acceptDeal = async (userId, postId) => {
        try {
            console.log(userId)
            console.log(postId)
            await axios.put("http://192.168.219.45:8080/waitingdeal/accept", null, {
                params: {
                    userId: userId,
                    postId: postId
                }
    ...
    const rejectDeal = async (userId, postId) => {
        ...
        console.log(userId)
        console.log(postId)
        await axios.put("http://192.168.219.45:8080/waitingdeal/reject", null, {
            params: {
                userId: userId,
                postId: postId
            }
